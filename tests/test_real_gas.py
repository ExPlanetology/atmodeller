...
def test_fO2_holley() -> None:
    ...
    target: dict[str, Any] = {
        "gas": {
            "species": {
                "partial_pressure": {
                    "H2O_g": 32.77150764086231,
                    "H2_g": 71.50578586144273,
                    "O2_g": 1.5254660199722744e-21,
                }
            }
        }
    }
...
def test_chabrier_earth() -> None:
    ...
    target: dict[str, Any] = {
        "gas": {
            "species": {
                "partial_pressure": {
                    "H2O_g": 7252.147166219368,
                    "H2_g": 11624.699724488064,
                    "H4Si_g": 67596.63721431814,
                    "O2_g": 1.7913992366741027e-05,
                    "OSi_g": 625.5196541815442,
                },
                "activity": {
                    "H2O_g": 7252.147166219373,
                    "H2_g": 251668.0509889652,
                    "H4Si_g": 67596.63721431818,
                    "O2_g": 1.7913992366741037e-05,
                    "OSi_g": 625.5196541815445,
                },
            }
        },
    ...
    target: dict[str, Any] = {
        "gas": {
            "species": {
                ...
                "activity": {
                    "H2O_g": 429507.1704491535,
                    "H2_g": 19567.21447690322,
                    "H4Si_g": 0.000704240746855,
                    "O2_g": 10.394369851620437,
                    "OSi_g": 0.821179444164849,
                },
            }
        },
        "O2Si_l": {"species": {"activity": {"O2Si_l": 1.0}}},
...
def test_pH2_fO2_real_gas() -> None:
    ...
    target: dict[str, Any] = {
        "gas": {
            "species": {
                "partial_pressure": {
                    "H2O_g": 1470.2003824504136,
                    "H2_g": 999.9680041351174,
                    "O2_g": 1.0453574209588052e-07,
                }
            }
        }
    }
...
def test_subNeptune_melt_phase() -> None:
    ...
    target: dict[str, Any] = {
        "gas": {
            "species": {
                "partial_pressure": {
                    "H2O_g": np.array([34153.830741613696, 34647.10590262693, 34773.426887896916]),
                    "H2_g": np.array([1.9533474360590362, 0.1649042207958084, 0.026748852179358396]),
                    "O2_g": np.array([34654.48940856429, 118719.9469235665, 205321.6303802464]),
                },
                "activity": {
                    "H2_g": np.array([26.94742918139355, 14.769397743175231, 11.271658169843118])
                },
            }
        },
        "silicate_melt": {
